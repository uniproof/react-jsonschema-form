...
function BaseInput(props) {
  console.log("BaseInput", props); // Note: since React 15.2.0 we can't forward unknown element attributes, so we
  ...
  var value = props.value,
      ...
      index = props.index,
      inputProps = (0, _objectWithoutProperties2["default"])(props, ["value", "readonly", "disabled", "autofocus", "onBlur", "onFocus", "options", "schema", "formContext", "registry", "rawErrors", "index"]); // If options.inputType is set use that as the input type
