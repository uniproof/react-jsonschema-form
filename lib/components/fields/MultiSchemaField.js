...
function (_Component) {
  ...
  function AnyOfField(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getCurrentOption", function (formData, options) {
      var __type = formData.__type;

      var ref = __type.replace(".", "#/definitions/");
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onOptionChange", function (option) {
      ...
      var definitions = registry.definitions; // If the new option is of type object and the current data is an object,
      // discard properties added using the old option.

      var newFormData = undefined; // Call getDefaultFormState to make sure defaults are populated on change.
  ...
  (0, _createClass2["default"])(AnyOfField, [{
    ...
    value: function getMatchingOption(formData, options) {
      ...
      if (formData && formData.__type) {
        return this.getCurrentOption(formData, options);
      } else {
